...
class Selector2:
    ...
    def __call__(self):
        ...
        subtrain_data, valid_data, subtrain_label, valid_label = Selector2.split_data(self.train_data, 
                                                                                      self.train_label)
        ...
        for rate in self.rate_list:
            ...
            # trian the model
            valid_loss = Selector2.__train__(subtrain_data, subtrain_label, 
    ...
    def __train__(subtrain_data, subtrain_label, valid_data, 
        ...
        step = 0
        valid_losses = []
        optimizer = optim.Adam(model.parameters(),  lr= 1e-4, weight_decay = rate)
