...
inputs = np.delete(inputs, 9, 1)
inputs = np.delete(inputs, 13, 1)
...
optimizer = optim.SGD(baselineNN.parameters(), lr = step_size)
...
plt.xlabel("step of every 5 min-bath")
plt.ylabel("loss")
plt.show()
...
print(criterion(best_output, test_label))
print(test_accuracy)
